    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
            ...
            <div class="input-group">
                ...
                <div class="input-box">
                    <input type="text" onkeyup="numberonly(this)" maxlength="16" placeholder="Aadhar" class="name" name="aadhar" required>
                    <i class="fa fa-user icon"></i>
                </div>
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                <div class="input-box">
                    <input type="text" onkeyup="numberonly(this)" placeholder="Enter Ammount" required class="name" name="amm">
                    <i class="fa fa-envelope icon"></i>
                </div>
            </div>
            <div class="input-group">
            ...
            if (isset($_POST['submit'])) {
                ...
                $insertquery = "insert into money(name,aadhar,email,gender,amm,upi) values ('$name','$aadhar','$email','$gender','$amm','$upi')";
